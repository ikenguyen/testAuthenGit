...
define(['order-tracker'], function (orderTracker) {
    ...
    var injectParams = ['$scope','$controller', '$location', '$route', 'modalService', 'customerService'];

    var CustomerController = function ($scope, $controller, $location, $route, modalService, customerService) {
        var args = {
            $scope: $scope,
            title : "Customer",
            lang : "Customer"
        ...
        this.isCreate() && ($scope.title = "Customer.Create");
        this.isUpdate() && ($scope.title = "Customer.Update");

    };

    CustomerController.$inject = injectParams;

    orderTracker.register.controller('CustomerController', CustomerController);
